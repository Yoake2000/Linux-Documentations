...
- # Notes:
	...
	- `auto-cpufreq` may show the following "Warning: CPU turbo is not available" on its status. An [issue](https://github.com/AdnanHodzic/auto-cpufreq/issues/602) has already been filed in its github repo regarding it. It is a bug since turbo still works; maxing out the CPU